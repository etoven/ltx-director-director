...
Independent audio clips cannot finish a move or trim on top of another clip. Dragging within the current gap stops at neighboring clip edges; dragging past another independent clip swaps their timeline order while preserving the existing gaps. Coupled video audio remains fixed and acts as a boundary that independent clips cannot cross.
